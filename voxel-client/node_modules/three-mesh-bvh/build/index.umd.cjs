(function (global, factory) {
	...
	const _tempBox = /* @__PURE__ */ new three.Box3();
	...
	const _direction = /* @__PURE__ */ new three.Vector3();
	...
	class MeshBVH extends GeometryBVH {
		...
		raycastObject3D( object, raycaster, intersects = [] ) {
			...
			_inverseMatrix$2.copy( object.matrixWorld ).invert();
	...
	const vec = /* @__PURE__ */ new three.Vector3();
	...
	function acceleratedRaycast( raycaster, intersects ) {
		...
		if ( this.isBatchedMesh ) {
			...
			if ( geometry.boundsTree ) {
				...
				} else if ( this instanceof three.LineSegments ) {

					raycastFunction = _raycastFunctions.LineSegments;

				} else if ( this instanceof three.LineLoop ) {
...
`;
	...
	exports.GeometryBVH = GeometryBVH;
	exports.INTERSECTED = INTERSECTED;
	exports.IntVertexAttributeTexture = IntVertexAttributeTexture;
	exports.LineBVH = LineBVH;
	exports.LineLoopBVH = LineLoopBVH;
	exports.LineSegmentsBVH = LineSegmentsBVH;
	...
	exports.PointsBVH = PointsBVH;
	exports.SAH = SAH;
	exports.SKIP_GENERATION = SKIP_GENERATION;
	...
	exports.generateIndirectBuffer = generateIndirectBuffer;
